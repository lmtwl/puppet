server {
    listen 80;
    server_name act.xunyiii.com orig.act.xunyiii.com;
...
server {
    ...
    ssl_certificate /etc/nginx/ssl/act.xunyiii.com.crt;
    ssl_certificate_key /etc/nginx/ssl/act.xunyiii.com.key;
