server {
    listen 80;
    server_name wb.xunyou.com orig.wb.xunyou.com;
...
server {
    ...
    root /usr/share/nginx/wb.xunyou.com;
    ...
    fastcgi_param SCRIPT_FILENAME /usr/share/nginx/wb.xunyou.com/$real_script_name;
